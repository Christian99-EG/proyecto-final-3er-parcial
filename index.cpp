...
struct arbol
{
  float  nro_arbol; //costo
  struct arbol *izq; //izquierda del arbol
  struct arbol *der; //derecha del arbol

};

typedef struct arbol *ptrArbol;

void insertar_preciosArbol(ptrArbol &a,float valorC)
{
  if(a == NULL)
  {
    ptrArbol aux;
	aux = new (struct arbol);
    aux -> nro_arbol = valorC;
    aux -> izq = NULL;
    aux -> der = NULL;
    a = aux;
  }else{
    if(valorC < a -> nro_arbol){
      insertar_preciosArbol(a -> izq,valorC);
    }else if(valorC > a -> nro_arbol){
      insertar_preciosArbol(a -> der,valorC);
    }else{
      //seran numeros repetidos
    }
  }
}
void preorden(ptrArbol &a)
{
  if(a != NULL)
  {
    cout<<"["<<a->nro_arbol<<"]";
...
class Tienda_matriz
{
  ...
  //funciones amigas para el arbol
  friend void insertar_preciosArbol(ptrArbol &a,float valorC);
  friend void preorden(ptrArbol &a);
  friend void inorden(ptrArbol &a);
  friend void postorden(ptrArbol &a);
  //fin de las funciones amigas para el arbol
...
void Tienda_matriz::mostrar_arbol()
{

  cout<<"\t\t\t *****************************************************************************************"<<endl;
  cout<<"\t\t\t *   se visualiza las ventas actuales en acorde al orden se se muestran a continuacion   *"<<endl;
  cout<<"\t\t\t *****************************************************************************************"<<endl;

  if(a != NULL){
  cout<<"preorden de la venta actual que se realiza en esta sesion: "<<endl;
  preorden(a);
  cout<<endl;

  cout<<"\n inorden de la venta actual que se realiza en esta sesion: "<<endl;
  inorden(a);
  cout<<endl;

  cout<<"\n postorden de la venta que se realiza en esta sesion: "<<endl;
  postorden(a);
  cout<<endl;

  cout<<"\n"<<endl;
  cout<<"\t\t\t *****************************************************************************"<<endl;
  cout<<"\t\t\t *  se visualizan en un orden, (mayor a menor venta, menor a mayor venta).   *"<<endl;
  cout<<"\t\t\t *****************************************************************************"<<endl;

}else{
  cout<<"actualmente su estrutura arbol esta vacio \n"<<endl;
 }
}
class caballeros
{
...
void menu(void)
{
  ...
  cout<<"\t\t\t\t *----------------------------------------------------------*"<<endl;
  cout<<"\t\t\t\t * 10. IR A REGISTROS DE VENTAS   (SOLO PRECIOS)            *"<<endl;
  cout<<"\t\t\t\t ************************************************************"<<endl;
  cout<<"\n"<<endl;
  ...
  break;}
    ...
    case 10:{//REGISTROS DE VENTAS

      ptrArbol a = NULL;
      int Cont = 0;
      cout<<"\t\t\t ******************************************************************* \t\t\t"<<endl;
      cout<<"\t\t\t *             BIENVENIDO AL AREA DE REGISTROS DE VENTAS           * \t\t\t"<<endl;
      cout<<"\t\t\t ******************************************************************* \t\t\t"<<endl;

      objtiendaMatriz.mostrar_arbol();
      cout<<"\n"<<endl;
 ...
 }while(opcionP != 0);} //fin del menu


/*void almacen(void)
{
  Tienda_matriz objarbol;

  ptrArbol a = NULL;
  int Cont = 0;
  cout<<"\t\t\t ******************************************************************* \t\t\t"<<endl;
  cout<<"\t\t\t *                    BIENVENIDO AL AREA DE ALMACEN                * \t\t\t"<<endl;
  cout<<"\t\t\t ******************************************************************* \t\t\t"<<endl;

  objarbol.mostrar_arbol();
